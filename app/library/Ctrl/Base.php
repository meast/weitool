 ...
 * charset:utf-8
 */
 abstract class Ctrl_Base extends Yaf\Controller_Abstract
 {
	...
	public function init()
	{
		...
		$this -> getView() -> assign('pagetitle', '');
		$this -> getView() -> assign('headcontent', '');
		...
		if(!Yaf\Dispatcher::getInstance() -> getRequest() -> isXmlHttpRequest())
		{
